...
public class OrderBean
{
    ...
    public String ordersGet(String oucu, String password)
    {
        ...
        String response = oclient.get_application_json(String.class, oucu,
                password);
    ...
    /**
     * Get a list of current order items and return as HTML table
     *
     * @param oucu the user's oucu
     * @param password the user's password
    ...
    {
        OrderItems oiclient = new OrderItems();
        String response = oiclient.get_application_json(String.class, oucu,
                password);
        JsonObject jo = Utilities.getAsJsonObject(response);
    ...
    /**
     * POST a new order - oucu and password from login bean, Client id from
     * order form.
     *
     * @param oucu the user's oucu
     * @param password the user's password
    ...
    {
        Orders oclient = new Orders();
        String response = oclient.post_application_x_www_form_urlencoded(
                String.class, oucu, password, clientId, latitude, longitude);
        oclient.close();
        return response;
    ...
    {
        OrderItems oiclient = new OrderItems();
        return oiclient.post_application_x_www_form_urlencoded(String.class,
                oucu, password, orderId, widgetId, number, pence);
    }
