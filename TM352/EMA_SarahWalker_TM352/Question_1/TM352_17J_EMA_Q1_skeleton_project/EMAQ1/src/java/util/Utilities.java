...
public class Utilities
{
   ...
   public static String prettyOrders(JsonArray orders)
   {
      ...
      /**
    * Prettify Orders Items data
    *
    * @param orderItems JsonArray of order items
    * @return HTML table of order items data, as a String
    */
   public static String prettyOrderItems(JsonArray orderItems)
   {
      ...
      temp.append(String.format(header, "order items id", "order id", "widget id", "number of widgets", "price(pence)"));
      ...
      for (int i = 0; i < orderItems.size(); i++)
      {
         ...
         String price = jo.getString("pence_price");

         temp.append(String.format(row, id, order_id, widget_id, number, price));

         System.out.println(String.format(row, id, order_id, widget_id, number, price));
      }
