    ...
    bindEvents: function() {
        ...
        function TaxiShare() {
                ...
                var onSuccess = function(position) {
                    ...
                    function onMapReady() { //MiL Edit 10Mar2018
                        ...
                        if (address != undefined) {
                            // TODO 2(a) FR2.2
                            var url = "http://nominatim.openstreetmap.org/search/" + encodeURI(address) + "?format=json&countrycode=gb";
                            $.get(url,
                                function(data) {
                                    if (data.length > 0) {
                                        currentLocation = new plugin.google.maps.LatLng(data[0].lat, data[0].lon);
                                        map.addMarker({
            ...
            function updateMatchingStatus(address) {
                ...
                if (oucu == "") return;
                /* Invoke the RESTful API to get all the matching addresses */
                var url = 'http://137.108.93.222/openstack/taxi/matches?OUCU=' + oucu;
